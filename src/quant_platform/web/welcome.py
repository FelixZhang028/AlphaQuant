...
def _render_product_overview() -> None:
    ...
    carousel_html = (
        ...
        :root{color-scheme:dark}html,body{margin:0;background:linear-gradient(145deg,#081120 0%,#0c1a33 48%,#080d19 100%);color:#eef5fd;font-family:Arial,sans-serif}*{box-sizing:border-box}
